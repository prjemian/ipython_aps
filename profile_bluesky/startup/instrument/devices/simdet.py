...
class myHdf5EpicsIterativeWriter(
    APS_devices.AD_EpicsHdf5FileName, FileStoreIterativeWrite
):
    pass
...
try:
    ...
    logger.warn(
        f"Could not connect {_ad_prefix} sim detector as 'adsimdet'"
    )
...
try:
    ...
    logger.warn(
        f"Could not connect {_ad_prefix} sim detector as 'altsimdet'"
    )
